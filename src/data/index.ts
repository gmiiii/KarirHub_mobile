...
export const sellerPlans = [
  {
    ...
    period: 'selamanya',
    highlight: false,
    features: ['3 layanan aktif', 'Komisi 10%', 'Dashboard dasar', 'Dukungan komunitas'],
    cta: 'Paket saat ini',
  },
  {
    name: 'Pro',
    ...
    period: 'bulan',
    highlight: true,
    features: ['Layanan tak terbatas', 'Komisi 5%', 'Analitik lengkap', 'Badge terverifikasi', 'Prioritas pencarian'],
    cta: 'Pilih paket Pro',
  },
  {
    name: 'Bisnis',
    ...
    period: 'bulan',
    highlight: false,
    features: ['Semua fitur Pro', 'Komisi 3%', 'Tim hingga 5 orang', 'Manajer akun khusus'],
...
// CV kandidat (dokumen milik pengguna). Dipakai di layar profil dan cv-saya.
// Bentuk dijaga sama dengan web (src/lib/data.ts) agar mudah disambungkan ke API.
...
export const RINA_PHOTO: ImageSourcePropType = require('../../assets/dummy/rina.jpg');
